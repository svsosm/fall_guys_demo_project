...
public class GirlL : Agent
{
    ...
    private OpponentStateL opponentState;
    ...
    public override void OnEpisodeBegin()
    {
        ...
        opponentState = OpponentStateL.IDLE;
    }
    ...
    public override void OnActionReceived(ActionBuffers actions)
    {
        ...
        {
            opponentState = OpponentStateL.FALLING;
    ...
    void MoveAndRotateCharacter(float rotY)
    {
        ...
        opponentState = OpponentStateL.RUNNING;
    }
